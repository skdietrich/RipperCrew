...
### Official Digital Companion & Forensic Excavation

[![Live Site](https://img.shields.io/badge/Site-Live-red)](https://YOUR_GITHUB_USERNAME.github.io/ripper-reboot/)
[![Book Status](https://img.shields.io/badge/Status-Top--Selling-darkred)]()
...
* `index.html`: The structural foundation of the landing page.
* `style.css`: The visual identity—industrial "Noir" aesthetics, blood-red highlights, and typewriter typography.
* `script.js`: Interactive elements, including the Forensic Map logic and the prose comparison engine.
* `/assets`: High-resolution Chicago-centric historical imagery and book cover art.
...
---
© 2026 Dr. Stephen Dietrich-Kolokouris. All rights reserved. 
*Inspired by the historical crimes of the Chicago Ripper Crew. Some liberties have been taken for narrative purposes.*
